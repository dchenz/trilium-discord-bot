...
class DefaultApi:
    ...
    def create_backup(
        self,
        backup_name: Annotated[str, Field(strict=True, description="If the backupName is e.g. \"now\", then the backup will be written to \"backup-now.db\" file")],
    ...
    def search_notes(
        self,
        search: Annotated[StrictStr, Field(description="search query string as described in https://triliumnext.github.io/Docs/Wiki/search.html")],
        fast_search: Annotated[Optional[StrictBool], Field(description="enable fast search (fulltext doesn't look into content)")] = None,
        include_archived_notes: Annotated[Optional[StrictBool], Field(description="search by default ignores archived notes. Set to 'true' to includes archived notes into search results.")] = None,
        ancestor_note_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="search only in a subtree identified by the subtree noteId. By default whole tree is searched.")] = None,
        ancestor_depth: Annotated[Optional[StrictStr], Field(description="define how deep in the tree should the notes be searched")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="name of the property/label to order search results by")] = None,
        order_direction: Annotated[Optional[StrictStr], Field(description="order direction, ascending or descending")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="limit the number of results you want to receive")] = None,
        debug: Annotated[Optional[StrictBool], Field(description="set to true to get debug information in the response (search query parsing)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
