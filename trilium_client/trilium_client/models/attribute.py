...
class Attribute(BaseModel):
    ...
    """ # noqa: E501
    attribute_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="attributeId")
    ...
    __properties: ClassVar[List[str]] = ["attributeId", "noteId", "type", "name", "value", "position", "isInheritable", "utcDateModified"]
