...
class Branch(BaseModel):
    ...
    parent_note_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="parentNoteId")
    ...
    __properties: ClassVar[List[str]] = ["branchId", "noteId", "parentNoteId", "prefix", "notePosition", "isExpanded", "utcDateModified"]
