...
class Note(BaseModel):
    ...
    parent_note_ids: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, alias="parentNoteIds")
    child_note_ids: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, alias="childNoteIds")
    parent_branch_ids: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, alias="parentBranchIds")
    child_branch_ids: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, alias="childBranchIds")
    ...
    __properties: ClassVar[List[str]] = ["noteId", "title", "type", "mime", "isProtected", "blobId", "attributes", "parentNoteIds", "childNoteIds", "parentBranchIds", "childBranchIds", "dateCreated", "dateModified", "utcDateCreated", "utcDateModified"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['text', 'code', 'render', 'file', 'image', 'search', 'relationMap', 'book', 'noteMap', 'mermaid', 'webView', 'shortcut', 'doc', 'contentWidget', 'launcher']):
            raise ValueError("must be one of enum values ('text', 'code', 'render', 'file', 'image', 'search', 'relationMap', 'book', 'noteMap', 'mermaid', 'webView', 'shortcut', 'doc', 'contentWidget', 'launcher')")
        return value
